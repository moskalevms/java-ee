    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        try {
            ...
            if (productRepository.findAll().size() == 0 ){
                productRepository.insert(new Product(-1L,"Product1", "Desc", new BigDecimal(10)));
                productRepository.insert(new Product(-1L,"Product2", "Desc2", new BigDecimal(102)));
                productRepository.insert(new Product(-1L,"Product3", "Desc3", new BigDecimal(105)));
                productRepository.insert(new Product(-1L,"Product4", "Desc4", new BigDecimal(101)));
            }
